...
const cardUI = () => {
  data.recipes.forEach(
    ({ name, image, cuisine, rating, servings, mealType }) => {
      const newDiv = document.createElement("div");
      const popdata = { name, image, cuisine, rating, servings };
    ...
    <p1>${cuisine}</p1>
    <br>
    <h3 class="submeal">${mealType.join(", ")}</h3>
    <button onclick='handleCardClick(${JSON.stringify(popdata)})'>View</button>
    `;
...
const namebutton = document.getElementById("pop-up-content");
